    ...
    for model_name, model_cfg in app.config['MODELS'].items():
        ...
        with model_graphs[model_name].as_default():
            ...
            models[model_name].trainer.load_variables(
                "latest", "C:\\Users\\user\\Desktop\\24_project\\server\\groove2groove-master\\api\\experiments\\v01_drums\\latest.ckpt-24361")


@ app.route('/<model_name>', methods=['POST'])
@ limiter.limit(app.config.get('MODEL_RATE_LIMIT', None))
def run_model(model_name):
    os.system("python -m groove2groove.models.roll2seq_style_transfer --logdir C:\\Users\\user\\Desktop\\24_project\\server\\groove2groove-master\\api\\experiments\\v01_drums run-midi \
    --sample --softmax-temperature 0.6 \
    C:\\Users\\user\\Desktop\\24_project\\server\\groove2groove-master\\api\\uploads\\content.mid C:\\Users\\user\\Desktop\\24_project\\server\\groove2groove-master\\api\\uploads\\style.mid C:\\Users\\user\\Desktop\\24_project\\server\\groove2groove-master\\api\\uploads\\output.mid")
    ...
    # return flask.send_file(outputs)
